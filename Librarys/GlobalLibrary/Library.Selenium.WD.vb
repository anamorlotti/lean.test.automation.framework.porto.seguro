...
Namespace LibrarySeleniumWD
    ...
    Public Class SeleniumWDHelper
        ...
        Public Sub SetupTest()
            Dim pathServer As String = "C:\LeanTestAutomation\API\"
            Try
                ...
                Select Case p_appProcessName
                    ...
                    Case "iexplore"
                        ...
                        If p_ResetApplication Then
                            pc_util.StopProcess("iexplore")
                            pc_util.StopProcess("IEDriverServer")
                        End If

                        objSeleniumWD = New InternetExplorerDriver("C:\LeanTestAutomation\API")
                    Case "firefox"
                        'objSeleniumWD = New FirefoxDriver()
            ...
            Try
                Select Case windowHandles
                    Case LibraryGlobal.LibGlobal.windowHandles.FirstOrDefault
                        objSeleniumWD.SwitchTo().Window(objSeleniumWD.WindowHandles.Item(0))'objSeleniumWD.WindowHandles().LastOrDefault())
                    Case LibraryGlobal.LibGlobal.windowHandles.First
                        objSeleniumWD.SwitchTo().Window(objSeleniumWD.WindowHandles.Item(0))'objSeleniumWD.WindowHandles().First())
                    Case LibraryGlobal.LibGlobal.windowHandles.Last
                        objSeleniumWD.SwitchTo().Window(objSeleniumWD.WindowHandles.Item(1))
                End Select
            ...
            If WaitExist(ImgPathOrCoordinatesXY, typeIdentification) Then
                ...
                Try
                    ...
                    Catch ex As Exception
                        ...
                        Return False
                    End Try
                    If value <> "@Nothing" Then webElement.SendKeys(value)
                Catch ex As Exception
                    Try
                        MouseOverElement(webElement)
                        webElement.Click()
