'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 19/04/2018 15:47:03 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... Orquestrador Poposta
'Functionality:... Localizar Proposta no Kiprev
'Master Test:..... No Defined
'TableTest:....... test_Orquestrador_Poposta_Localizar_Proposta_no_Kiprev
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Orquestrador_Poposta_Localizar_Proposta_no_Kiprev
    Public Class test_Orquestrador_Poposta_Localizar_Proposta_no_Kiprev
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							Test.TestLog("Consumir o serviço Localizar Proposta no Kiprev", "O serviço Localizar Proposta no Kiprev deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço Localizar Proposta no Kiprev foi consumido com sucesso", typelog.Passed, , False)
							...
							If p_xmlSoapLeanTest.StatusCode = 200 Then
								Test.TestLog("Verificar o retorno do serviço Localizar Proposta no Kiprev", "O serviço Localizar Proposta no Kiprev retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço Localizar Proposta no Kiprev foi consumido com sucesso", typelog.Passed, , False)
							Else
							Test.TestLog("Verificar o retorno do serviço Localizar Proposta no Kiprev", "O serviço Localizar Proposta no Kiprev retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço Localizar Proposta no Kiprev não foi consumido com sucesso", typelog.Failed, , False)
							End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Orquestrador_Poposta_Localizar_Proposta_no_Kiprev.test_Orquestrador_Poposta_Localizar_Proposta_no_Kiprev.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Orquestrador_Poposta_Localizar_Proposta_no_Kiprev.test_Orquestrador_Poposta_Localizar_Proposta_no_Kiprev.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
