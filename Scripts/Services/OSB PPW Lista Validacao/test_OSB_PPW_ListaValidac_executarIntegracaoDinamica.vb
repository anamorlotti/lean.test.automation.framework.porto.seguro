'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 26/03/2018 11:50:25 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... OSB PPW ListaValidaç
'Functionality:... executarIntegracaoDinamica
'Master Test:..... No Defined
'TableTest:....... test_OSB_PPW_ListaValidac_executarIntegracaoDinamica
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_OSB_PPW_ListaValidac_executarIntegracaoDinamica
    Public Class test_OSB_PPW_ListaValidac_executarIntegracaoDinamica
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                    ...
                    Do While p_CountTest <> 0
                        Try
                            If CBool(vIsOpenSystem) Then 'if true open system else load new test without open system
								p_pathUrlApp = "http://slhkipre:vrg2r5ht@osbhmlcrp/PrevidenciaPpwListaValidacaoIntegrationService/v1/osb/proxy/PrevidenciaPPWListaValidacaoPSV1_0?WSDL"'xml.Read("urlLocal") 'Create urlLocal element in XML
								If Not Test.StartTests Then Return False
							End If
							vXMLParameters = Test.GetValueOutput(p_IDTest, p_TableTest, "vXMLParameters") 'get XMLParameters OSB PPW ListaValidaç
							vXMLRequestEnvelope = Test.GetValueOutput(p_IDTest, p_TableTest, "vXMLRequestEnvelope") 'get XMLRequestEnvelope OSB PPW ListaValidaç
							...
							p_xmlSoapLeanTest = Test.CallWebService(p_pathUrlApp, vXMLRequestEnvelope, vXMLParameters, p_TypeExecution) 'CallWebService OSB PPW ListaValidaç
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_OSB_PPW_ListaValidac_executarIntegracaoDinamica.test_OSB_PPW_ListaValidac_executarIntegracaoDinamica.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_OSB_PPW_ListaValidac_executarIntegracaoDinamica.test_OSB_PPW_ListaValidac_executarIntegracaoDinamica.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
