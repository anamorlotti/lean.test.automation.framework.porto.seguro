'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 20/03/2018 13:52:37 (By LeanTest Automation Test) 
'User:............ Admin
...
'TableTest:....... test_Portal_do_COL_GerarSegundaViaEndossoProposta
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Portal_do_COL_GerarSegundaViaEndossoProposta
    Public Class test_Portal_do_COL_GerarSegundaViaEndossoProposta
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
                            ...
                            Else
                                Test.TestLog("Verificar o retorno do serviço GerarSegundaViaEndossoProposta", "O serviço GerarSegundaViaEndossoProposta retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço GerarSegundaViaEndossoProposta não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Portal_do_COL_GerarSegundaViaEndossoProposta.test_Portal_do_COL_GerarSegundaViaEndossoProposta.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Portal_do_COL_GerarSegundaViaEndossoProposta.test_Portal_do_COL_GerarSegundaViaEndossoProposta.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
