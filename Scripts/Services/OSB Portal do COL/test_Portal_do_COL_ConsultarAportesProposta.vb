'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 19/03/2018 18:11:34 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... Portal do COL
'Functionality:... ConsultarAportesProposta
'Master Test:..... No Defined
'TableTest:....... test_Portal_do_COL_ConsultarAportesProposta
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Portal_do_COL_ConsultarAportesProposta
    Public Class test_Portal_do_COL_ConsultarAportesProposta
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							Test.TestLog("Consumir o serviço ConsultarAportesProposta", "O serviço ConsultarAportesProposta deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço ConsultarAportesProposta foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço ConsultarAportesProposta", "O serviço ConsultarAportesProposta retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço ConsultarAportesProposta foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço ConsultarAportesProposta", "O serviço ConsultarAportesProposta retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço ConsultarAportesProposta não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Portal_do_COL_ConsultarAportesProposta.test_Portal_do_COL_ConsultarAportesProposta.Run: " & ex.Message)
        ...
        Public Shared vXMLParameters,vXMLRequestEnvelope,vv1_codigoIdentificadorSessao, vv1_codigoAdministradora, vv1_codigoFilial, vv1_codigoProduto, vv1_codigoProposta, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Portal_do_COL_ConsultarAportesProposta.test_Portal_do_COL_ConsultarAportesProposta.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
