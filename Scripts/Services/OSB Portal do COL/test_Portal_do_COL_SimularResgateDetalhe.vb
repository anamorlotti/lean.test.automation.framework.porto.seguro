'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 20/03/2018 16:44:36 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... Portal do COL
'Functionality:... SimularResgateDetalhe
'Master Test:..... No Defined
'TableTest:....... test_Portal_do_COL_SimularResgateDetalhe
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Portal_do_COL_SimularResgateDetalhe
    Public Class test_Portal_do_COL_SimularResgateDetalhe
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							vXMLRequestEnvelope = Test.SetValueXMLElement("vv1_valorResgate", vv1_valorResgate,"", vXMLRequestEnvelope) 'type value in xml elementv1:valorResgate
							Test.TestLog("Consumir o serviço SimularResgateDetalhe", "O serviço SimularResgateDetalhe deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço SimularResgateDetalhe foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço SimularResgateDetalhe", "O serviço SimularResgateDetalhe retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço SimularResgateDetalhe foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço SimularResgateDetalhe", "O serviço SimularResgateDetalhe retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço SimularResgateDetalhe não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Portal_do_COL_SimularResgateDetalhe.test_Portal_do_COL_SimularResgateDetalhe.Run: " & ex.Message)
        ...
        Public Shared vXMLParameters,vXMLRequestEnvelope,vv1_codigoIdentificadorSessao, vv1_codigoFilial, vv1_codigoProduto, vv1_codigoProposta, vv1_valorResgate, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
					...
					vv1_valorResgate = pc_db.Fieldt("vv1_valorResgate")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Portal_do_COL_SimularResgateDetalhe.test_Portal_do_COL_SimularResgateDetalhe.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
