'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 20/03/2018 11:44:57 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... Portal do COL
'Functionality:... ConsultarPropostaDetalhe
'Master Test:..... No Defined
'TableTest:....... test_Portal_do_COL_ConsultarPropostaDetalhe
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Portal_do_COL_ConsultarPropostaDetalhe
    Public Class test_Portal_do_COL_ConsultarPropostaDetalhe
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							Test.TestLog("Consumir o serviço ConsultarPropostaDetalhe", "O serviço ConsultarPropostaDetalhe deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço ConsultarPropostaDetalhe foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço ConsultarPropostaDetalhe", "O serviço ConsultarPropostaDetalhe retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço ConsultarPropostaDetalhe foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço ConsultarPropostaDetalhe", "O serviço ConsultarPropostaDetalhe retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço ConsultarPropostaDetalhe não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Portal_do_COL_ConsultarPropostaDetalhe.test_Portal_do_COL_ConsultarPropostaDetalhe.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Portal_do_COL_ConsultarPropostaDetalhe.test_Portal_do_COL_ConsultarPropostaDetalhe.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
