'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 20/03/2018 14:37:28 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... Portal do COL
'Functionality:... SimularResgate
'Master Test:..... No Defined
'TableTest:....... test_Portal_do_COL_SimularResgate
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Portal_do_COL_SimularResgate
    Public Class test_Portal_do_COL_SimularResgate
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
                            ...
                            vXMLRequestEnvelope = Test.SetValueXMLElement("vvalorResgate", vvalorResgate, "", vXMLRequestEnvelope) 'type value in xml elementv1:vvalorResgate		
                            Test.TestLog("Consumir o serviço SimularResgate", "O serviço SimularResgate deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço SimularResgate foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço SimularResgate", "O serviço SimularResgate retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço SimularResgate foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço SimularResgate", "O serviço SimularResgate retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço SimularResgate não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Portal_do_COL_SimularResgate.test_Portal_do_COL_SimularResgate.Run: " & ex.Message)
        ...
        Public Shared vvalorResgate, vXMLParameters,vXMLRequestEnvelope,vv1_codigoIdentificadorSessao, vv1_codigoFilial, vv1_codigoProduto, vv1_codigoProposta, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
                    ...
                    vvalorResgate = pc_db.Fieldt("vvalorResgate")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Portal_do_COL_SimularResgate.test_Portal_do_COL_SimularResgate.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
