'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 20/03/2018 14:07:27 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... Portal do COL
'Functionality:... HistoricoResgate
'Master Test:..... No Defined
'TableTest:....... test_Portal_do_COL_HistoricoResgate
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Portal_do_COL_HistoricoResgate
    Public Class test_Portal_do_COL_HistoricoResgate
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							vXMLRequestEnvelope = Test.SetValueXMLElement("vv1_numeroSolicitacao", vv1_numeroSolicitacao,"", vXMLRequestEnvelope) 'type value in xml elementv1:numeroSolicitacao
							Test.TestLog("Consumir o serviço HistoricoResgate", "O serviço HistoricoResgate deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço HistoricoResgate foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço HistoricoResgate", "O serviço HistoricoResgate retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço HistoricoResgate foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço HistoricoResgate", "O serviço HistoricoResgate retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço HistoricoResgate não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Portal_do_COL_HistoricoResgate.test_Portal_do_COL_HistoricoResgate.Run: " & ex.Message)
        ...
        Public Shared vXMLParameters,vXMLRequestEnvelope,vv1_codigoIdentificadorSessao, vv1_codigoAdministradora, vv1_codigoFilial, vv1_codigoProduto, vv1_codigoProposta, vv1_numeroSolicitacao, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
					...
					vv1_numeroSolicitacao = pc_db.Fieldt("vv1_numeroSolicitacao")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Portal_do_COL_HistoricoResgate.test_Portal_do_COL_HistoricoResgate.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
