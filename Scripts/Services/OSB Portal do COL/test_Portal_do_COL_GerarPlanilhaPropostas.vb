'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 20/03/2018 13:22:16 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... Portal do COL
'Functionality:... GerarPlanilhaPropostas
'Master Test:..... No Defined
'TableTest:....... test_Portal_do_COL_GerarPlanilhaPropostas
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Portal_do_COL_GerarPlanilhaPropostas
    Public Class test_Portal_do_COL_GerarPlanilhaPropostas
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							Test.TestLog("Consumir o serviço GerarPlanilhaPropostas", "O serviço GerarPlanilhaPropostas deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço GerarPlanilhaPropostas foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço GerarPlanilhaPropostas", "O serviço GerarPlanilhaPropostas retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço GerarPlanilhaPropostas foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço GerarPlanilhaPropostas", "O serviço GerarPlanilhaPropostas retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço GerarPlanilhaPropostas não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Portal_do_COL_GerarPlanilhaPropostas.test_Portal_do_COL_GerarPlanilhaPropostas.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Portal_do_COL_GerarPlanilhaPropostas.test_Portal_do_COL_GerarPlanilhaPropostas.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
