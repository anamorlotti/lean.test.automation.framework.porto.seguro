'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 19/03/2018 17:30:13 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... Portal do COL
'Functionality:... CarregarNovoAporte
'Master Test:..... No Defined
'TableTest:....... test_Portal_do_COL_CarregarNovoAporte
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Portal_do_COL_CarregarNovoAporte
    Public Class test_Portal_do_COL_CarregarNovoAporte
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							Test.TestLog("Consumir o serviço CarregarNovoAporte", "O serviço CarregarNovoAporte deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço CarregarNovoAporte foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço CarregarNovoAporte", "O serviço CarregarNovoAporte retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço CarregarNovoAporte foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço CarregarNovoAporte", "O serviço CarregarNovoAporte retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço CarregarNovoAporte não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Portal_do_COL_CarregarNovoAporte.test_Portal_do_COL_CarregarNovoAporte.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Portal_do_COL_CarregarNovoAporte.test_Portal_do_COL_CarregarNovoAporte.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
