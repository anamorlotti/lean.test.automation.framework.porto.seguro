'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 22/03/2018 16:51:25 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... PDC OSB
'Functionality:... consultarInformeRendimentos
'Master Test:..... No Defined
'TableTest:....... test_PDC_OSB_consultarInformeRendimentos
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_PDC_OSB_consultarInformeRendimentos
    Public Class test_PDC_OSB_consultarInformeRendimentos
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							Test.TestLog("Consumir o serviço consultarInformeRendimentos", "O serviço consultarInformeRendimentos deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço consultarInformeRendimentos foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço consultarInformeRendimentos", "O serviço consultarInformeRendimentos retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço consultarInformeRendimentos foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço consultarInformeRendimentos", "O serviço consultarInformeRendimentos retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço consultarInformeRendimentos não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_PDC_OSB_consultarInformeRendimentos.test_PDC_OSB_consultarInformeRendimentos.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_PDC_OSB_consultarInformeRendimentos.test_PDC_OSB_consultarInformeRendimentos.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
