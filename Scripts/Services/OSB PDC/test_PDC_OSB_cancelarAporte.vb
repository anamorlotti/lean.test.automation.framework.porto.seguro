'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 22/03/2018 11:03:56 (By LeanTest Automation Test) 
'User:............ Admin
...
'TableTest:....... test_PDC_OSB_cancelarAporte
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_PDC_OSB_cancelarAporte
    Public Class test_PDC_OSB_cancelarAporte
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							vXMLRequestEnvelope = Test.SetValueXMLElement("vnumeroAporte", vnumeroAporte,"", vXMLRequestEnvelope) 'type value in xml elementnumeroAporte
							vXMLRequestEnvelope = Test.SetValueXMLElement("vmotivoAporte", vmotivoAporte,"", vXMLRequestEnvelope) 'type value in xml elementmotivoAporte
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_PDC_OSB_cancelarAporte.test_PDC_OSB_cancelarAporte.Run: " & ex.Message)
        ...
        Public Shared vXMLParameters,vXMLRequestEnvelope,vnumeroAporte, vmotivoAporte, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
					...
					vnumeroAporte = pc_db.Fieldt("vnumeroAporte")
					vmotivoAporte = pc_db.Fieldt("vmotivoAporte")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_PDC_OSB_cancelarAporte.test_PDC_OSB_cancelarAporte.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
