'**********************************************************************************************************************************************************************
'Create by LeanTest Automation 3.8 in 12/04/2018 16:12:34 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... OSB PDC
'Functionality:... consultarBeneficiarios
'Master Test:..... No Defined
'TableTest:....... test_OSB_PDC_consultarBeneficiarios
'**********************************************************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_OSB_PDC_consultarBeneficiarios
    Public Class test_OSB_PDC_consultarBeneficiarios
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							Test.TestLog("Consumir o serviço consultarBeneficiarios", "O serviço consultarBeneficiarios deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço consultarBeneficiarios foi consumido com sucesso", typelog.Passed, , False)
							...
							If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço consultarBeneficiarios", "O serviço consultarBeneficiarios retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço consultarBeneficiarios foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço consultarBeneficiarios", "O serviço consultarBeneficiarios retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço consultarBeneficiarios não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
		p_errorDescription = "Menssage error: " & ex.Message.ToString
		HandlerError("test_OSB_PDC_consultarBeneficiarios.test_OSB_PDC_consultarBeneficiarios.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
		    ...
		    If String.IsNullOrEmpty(strQueryOut1) Then pc_db.TransferDataInTablesArray(strQueryOut1, p_TableTest, p_IDScenario, p_IDTest)
                ...
                End If
            Catch ex As Exception
                HandlerError("test_OSB_PDC_consultarBeneficiarios.test_OSB_PDC_consultarBeneficiarios.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
