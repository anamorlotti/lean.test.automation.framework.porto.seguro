'*********************************************************************************************************************************
'Create by LeanTest Automation 3.6 in 22/03/2018 17:38:52 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... PDC OSB
'Functionality:... consultarSaldos
'Master Test:..... No Defined
'TableTest:....... test_PDC_OSB_consultarSaldos
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_PDC_OSB_consultarSaldos
    Public Class test_PDC_OSB_consultarSaldos
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							vXMLRequestEnvelope = Test.SetValueXMLElement("vdataSolicitacao", vdataSolicitacao,"", vXMLRequestEnvelope) 'type value in xml elementdataSolicitacao
							Test.TestLog("Consumir o serviço consultarSaldos", "O serviço consultarSaldos deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço consultarSaldos foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço consultarSaldos", "O serviço consultarSaldos retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço consultarSaldos foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço consultarSaldos", "O serviço consultarSaldos retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço consultarSaldos não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_PDC_OSB_consultarSaldos.test_PDC_OSB_consultarSaldos.Run: " & ex.Message)
        ...
        Public Shared vXMLParameters,vXMLRequestEnvelope,vcodSucursal, vcodRamo, vseqApolice, vcodOrigem, vcodProposta, vdataSolicitacao, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
					...
					vdataSolicitacao = pc_db.Fieldt("vdataSolicitacao")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_PDC_OSB_consultarSaldos.test_PDC_OSB_consultarSaldos.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
