'**********************************************************************************************************************************************************************
'Create by LeanTest Automation 3.8 in 27/03/2018 16:00:54 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to WebService
'Environment:..... Automation Project
'Application...... AnaliseEspecial
'Functionality:... pesquisarAnalisesEspeciaisVida
'Master Test:..... No Defined
'TableTest:....... test_AnaliseEspecial_pesquisarAnalisesEspeciaisVida
'**********************************************************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_AnaliseEspecial_pesquisarAnalisesEspeciaisVida
    Public Class test_AnaliseEspecial_pesquisarAnalisesEspeciaisVida
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                ...
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
							...
							Test.TestLog("Consumir o serviço pesquisarAnalisesEspeciaisVida", "O serviço pesquisarAnalisesEspeciaisVida deve ser consumido com sucesso usando os valores " & vbCrLf & vXMLRequestEnvelope, "O serviço pesquisarAnalisesEspeciaisVida foi consumido com sucesso", typelog.Passed, , False)
                            ...
                            If p_xmlSoapLeanTest.StatusCode = 200 Then
                                Test.TestLog("Verificar o retorno do serviço pesquisarAnalisesEspeciaisVida", "O serviço pesquisarAnalisesEspeciaisVida retornou com sucesso usando os valores " & vbCrLf & p_xmlSoapLeanTest.InnerXML, "O serviço pesquisarAnalisesEspeciaisVida foi consumido com sucesso", typelog.Passed, , False)
                            Else
                                Test.TestLog("Verificar o retorno do serviço pesquisarAnalisesEspeciaisVida", "O serviço pesquisarAnalisesEspeciaisVida retornou a mensagem de erro: " & vbCrLf & p_xmlSoapLeanTest.ResponseError, "O serviço pesquisarAnalisesEspeciaisVida não foi consumido com sucesso", typelog.Failed, , False)
                            End If
            ...
            Catch ex As Exception
		p_errorDescription = "Menssage error: " & ex.Message.ToString
		HandlerError("test_AnaliseEspecial_pesquisarAnalisesEspeciaisVida.test_AnaliseEspecial_pesquisarAnalisesEspeciaisVida.Run: " & ex.Message)
        ...
        Public Shared vXMLParameters,vXMLRequestEnvelope,vv1_cpf, vv1_digito, vv1_cgcord, vv1_origemPropostaPrincipal, vv1_numeroPropostaPrincipal, vv1_dataNascimento, vv1_statusAnalise, vv1_rg, vv1_ramo, vv1_codigoUnidadeOperacional, vv1_nomeSegurado, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
		    ...
		    If String.IsNullOrEmpty(strQueryOut1) Then pc_db.TransferDataInTablesArray(strQueryOut1, p_TableTest, p_IDScenario, p_IDTest)
                ...
                End If
            Catch ex As Exception
                HandlerError("test_AnaliseEspecial_pesquisarAnalisesEspeciaisVida.test_AnaliseEspecial_pesquisarAnalisesEspeciaisVida.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
