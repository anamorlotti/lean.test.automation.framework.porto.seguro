'**********************************************************************************************************************************************************************
'Create by LeanTest Automation 3.8 in 07/05/2018 11:11:45 (By LeanTest Automation Test) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation to File
'Environment:..... Automation Project
'Application...... Batch PortoCap
'Functionality:... Remessa VPREM
'Master Test:..... No Defined
'TableTest:....... test_Batch_PortoCap_Remessa_VPREM
'**********************************************************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal
Namespace test_Batch_PortoCap_Remessa_VPREM
    Public Class test_Batch_PortoCap_Remessa_VPREM
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                    ...
                    Do While p_CountTest <> 0
                        Try
                            If CBool(vIsOpenSystem) Then 'if true open system else load new test without open system
								p_pathUrlApp = "C:\LeanTestAutomation\Scripts\lean.test.automation.framework.porto.seguro\Files\Saída_Portocap\RMVPREM1071117.TXT"'xml.Read(""urlLocal"") 'Create urlLocal element in XML
								Test.TestLog("Abrir o arquivo Batch PortoCap", "O arquivo  Remessa VPREM deve ser aberto para leitura", "O arquivo Remessa VPREM foi aberto com sucesso", typelog.Passed, , False)
							End If
            ...
            Catch ex As Exception
		p_errorDescription = "Menssage error: " & ex.Message.ToString
		HandlerError("test_Batch_PortoCap_Remessa_VPREM.test_Batch_PortoCap_Remessa_VPREM.Run: " & ex.Message)
        ...
        Public Shared vtipoRegistro, vTipo_arquivo, vNome_empresa, vCGC_empresa, vData_sorteio, vVersao_arquivo, vProduto, vTipo_registro2, vNr_serie_sorteio, vNr_sorteio, vNome_cliente, vData_sorteio_1, vCodigo_cliente_parceria, vValor_mensalidade, vTipo_registro_trailler, vQuantidade_registros, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
		    ...
		    If String.IsNullOrEmpty(strQueryOut1) Then pc_db.TransferDataInTablesArray(strQueryOut1, p_TableTest, p_IDScenario, p_IDTest)
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Batch_PortoCap_Remessa_VPREM.test_Batch_PortoCap_Remessa_VPREM.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
